...
//                    .padding(.top,25)
                ...
                HStack{
                        Text(String(self.favoriteViewModel.favoriteUsers.count))
                    Text("내가 끌림을 준 카드")
                        .font(.title)
                        .fontWeight(.bold)
                ...
                LazyVGrid(columns: self.columns,spacing: 25){
                    ...
                    ForEach(self.favoriteViewModel.favoriteUsers){user in
                        ...
                        GridView(user: user,columns: self.$columns)
                    }
                }
        ...
        .background(Color.black.opacity(0.05).edgesIgnoringSafeArea(.all)).onAppear(){

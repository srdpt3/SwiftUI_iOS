...
struct ChartView2: UIViewRepresentable {
    
    @Binding var data : [Double]
    var totalNum : Int
    var categories : [String]
    let hexColor = "#627AFA"
    let areaType = AAChartType.line
    let aaChartView = AAChartView()
    let animationType : AAChartAnimationType = AAChartAnimationType.linear
//Animation type
//    case linear
//    case easeInQuad
//    case easeOutQuad
...
//            .animationType(animationType)
            ...
            .series([
                AASeriesElement().name("남자")
                    .data([data[0],data[1],data[2],data[3],data[4]]),
                AASeriesElement().name("여자")
                                 .data([data[1],data[3],data[0],data[4],data[2]]),
            ])
        ...
        ["data": [data[1],data[2],data[4],data[3],data[0]] as AnyObject]])
    }

...
struct ContentView: View {
    ...
    var body: some View {
        NavigationView{
            ...
            }.navigationBarTitle("Restaurant near me")
        }
...
class observer : ObservableObject{
    ...
    init() {
        ...
        let url1 = "https://developers.zomato.com/api/v2.1/geocode?lat=40.7680&lon=-73.9819"
        let api = "3d3a65688bb67a33ae1998c4e197d704"
